...
print(s1.upper())
print(s1.title())
print(s1.capitalize())   #i an a student. i live in delhi.
print(s1.swapcase())
...
""" s1="{} is a good boy. He studies in {}" .format("Amit","Delhi")
print(s1)

place="Delhi"
name="Amit"
s1="{0} is a good boy. He studies in {1}" .format(name,place)
print(s1)
...
place="Delhi"
name="Amit"
s1=f'{name} is a good boy. He studies in {place}'
print(s1) """
...
text = "My name is Saloni"
result = "remove_odd_index_loop"
result ="a"
...
""" str1="thequickbrownforxjumpoverthelazydog"
substr=""
for i in str1:
    if i not in substr and str1.count(i)>1:
        substr+=i+" "+str(str1.count(i))+" "
print(substr.strip()) """
